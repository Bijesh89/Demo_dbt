...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # To get the name of best model from dict
            ...
            logging.info(f'Best model found on both training and test dataset: {best_model_name} with r2 score: {best_model_score}')
